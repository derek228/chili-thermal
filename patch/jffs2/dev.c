...
#if 1 // derek jffs2 image partition
//	{
//		.name = "u-boot",    /* uboot, kernel 20Mbyte*/
//		.size = 0x200000,
//		.offset = 0,
//	},
	{
		.name = "kernel",    /* uboot, kernel 20Mbyte*/
		.size = 0x800000, // 0x600000,
		.offset = 0,//0x200000,
	},
	{
